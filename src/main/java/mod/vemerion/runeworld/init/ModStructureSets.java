...
public class ModStructureSets {
	...
	public static class Keys {
	  ...
	  public static final ResourceKey<StructureSet> BLOOD_MONKEY_TUNNELS = ResourceKey.create(Registry.STRUCTURE_SET_REGISTRY, new ResourceLocation(Main.MODID, "blood_monkey_tunnels"));
	}
	...
	public static Holder<StructureSet> BLOOD_MONKEY_TUNNELS;
	...
	public static void register() {
		...
		BLOOD_MONKEY_TUNNELS = BuiltinRegistries.register(reg, Keys.BLOOD_MONKEY_TUNNELS, new StructureSet(ModConfiguredStructures.BLOOD_MONKEY_TUNNELS, new RandomSpreadStructurePlacement(64, 8, RandomSpreadType.LINEAR, 2732226)));
	}
}
